...
RickMortyModel rickMortyModelFromJson(String str) =>
    RickMortyModel.fromJson(json.decode(str));

String rickMortyModelToJson(RickMortyModel data) => json.encode(data.toJson());
